...
document.getElementsByClassName('show_sign_up')[0].addEventListener("click", function(){
    ...
    document.getElementById('hmm').onclick='sign_up()';
    document.getElementById('hmm').action='./home.html';
});
...
document.getElementsByClassName('show_sign_in')[0].addEventListener("click",function(){
    ...
    document.getElementById('hmm').onclick='sign_in()';
    document.getElementById('hmm').action='./home.html';
});
...
document.getElementsByClassName('show_admin_login')[0].addEventListener('click',function(){
    ...
    document.getElementById('hmm').onclick='admin_login()';
    document.getElementById('hmm').action='./button.html';
});

console.log(document.getElementsByClassName('show_sign_up'))